...
The Global tribe, specifically the Capabilities squad, oversees the Notification service, Notification Center, and Notification Settings. Hop into [*#eng-*](https://sproutsocial.slack.com/app_redirect?channel=eng-notifications)*notifications* and mention @capabilities so we can be sure to give you attention.
